...
install.packages(c("tidyverse","ggpubr"))  #De-comment the code to install
...
ElderlyPopWA <- read.csv("~/Desktop/ElderlyPopWA.csv")
...
Salary_Data <- read.csv("~/Desktop/Salary_Data.csv")  #Import the salary dataset
View(Salary_Data)
